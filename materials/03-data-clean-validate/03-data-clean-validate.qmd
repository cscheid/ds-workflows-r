...
::: {define-cell="summary_table_basic"}
```{r}
#| echo: false
if (stop_alert != TRUE) {
  summary_table_basic # there should be a slicker way to do this with library(quarto)
}
```

:::

::: {define-cell="summary_table_full"}
```{r}
#| echo: false
if (stop_alert != TRUE & !Sys.getenv("CONDITION_OVERRIDE") %in% conditions) {
  summary_table_full # there should be a slicker way to do this with library(quarto)
}
```
